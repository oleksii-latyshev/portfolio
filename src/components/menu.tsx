...
export const Menu: FC = ({}) => {
  ...
  return (
    <nav className='relative z-[777]'>
      <motion.div
        className='fixed left-1/2 top-0 h-[4.5rem] w-full rounded-none bg-secondary/60 shadow-lg backdrop-blur-lg sm:top-6 sm:h-[3.25rem] sm:w-[33rem] sm:rounded-full'
